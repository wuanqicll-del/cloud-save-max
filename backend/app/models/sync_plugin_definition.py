...
class SyncPluginDefinition(Base):
    __tablename__ = "sync_plugin_definitions"
    ...
    config = relationship("SyncPluginConfig", back_populates="definition", uselist=False, lazy="selectin")
