...
class AuditLogSchedulerSetting(Base):
    __tablename__ = "audit_log_scheduler_settings"

    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="0")
    crontab: Mapped[str] = mapped_column(String(64), nullable=False, server_default="0 3 * * *")
