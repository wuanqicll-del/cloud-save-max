...
export async function fetchTaskSuggestions(q: string, d: number, drive_type?: string | null, search_filter?: string, search_exclude?: string, search_date_from?: string, search_filter_mode?: string, search_exclude_mode?: string) {
